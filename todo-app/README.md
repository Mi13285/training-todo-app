...
## 🛠 Используемый технологический стек (Tech Stack):
*   **React 18** — Использование функциональных компонентов, хуков (`useState`) и оптимизированного виртуального DOM.
*   **HTML5** — Семантическая разметка интерфейса "Планшета" для обеспечения доступности.
*   **CSS3** — Кастомная стилизация элементов без использования готовых UI-библиотек, адаптивная верстка физических объектов (планшет, карандаш).
